...
class AnalyticsController < ApplicationController
     ...
     def index
          ...
          query_activity_counts_by_type
          query_completed_member_activities_by_type(filter_date, user_id)
          query_total_member_activities_by_type(filter_date, user_id)
          query_member_activities_by_activity(filter_date, user_id)
          query_completed_member_activities_by_activity(filter_date, user_id)
          load_platoons
     end
     ...
     def query_activity_counts_by_type
          @activity_counts_by_type = Activity.joins(:activity_type).group('activity_types.id').count
     end

     def query_completed_member_activities_by_type(filter_date, user_id)
     ...
     def query_total_member_activities_by_type(filter_date, user_id)
          @memberactivity_counts_by_type = MemberActivity.joins(activity: :activity_type)
     ...
     def query_member_activities_by_activity(filter_date, user_id)
          @memberactivity_counts_by_activity = MemberActivity.joins(:activity)
     ...
     def query_completed_member_activities_by_activity(filter_date, user_id)
