...
class MemberEventsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create member_event" do
    assert_difference("MemberEvent.count") do
      post member_events_url, params: { member_event: { date: @member_event.date, event_id: @member_event.event_id, time_spent: @member_event.time_spent, user_id: @member_event.user_id } }
    end
  ...
  test "should update member_event" do
    patch member_event_url(@member_event), params: { member_event: { date: @member_event.date, event_id: @member_event.event_id, time_spent: @member_event.time_spent, user_id: @member_event.user_id } }
